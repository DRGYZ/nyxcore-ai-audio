...
export const mockReviewReport: ReviewReport = {
  summary: {
    total_items: 5,
    counts_by_type: { exact_duplicate_group: 1, likely_duplicate_group: 1, missing_metadata: 1, low_quality_audio: 1, folder_hotspot: 1 },
    counts_by_priority_band: { high: 2, medium: 2, low: 1 },
    counts_by_state: { new: 2, seen: 2, snoozed: 1 },
    total_files_referenced: 7,
  },
  metadata: {
    active_profile: "default",
  ...
  items: [
    {
      ...
      review_status: "new",
      affected_paths: [
        "/Volumes/Media/Jazz/Blue Train.flac",
        "/Downloads/Imports/Blue Train copy.mp3",
        "/Desktop/Transfers/Blue Train duplicate.m4a",
      ],
      sample_paths: ["/Volumes/Media/Jazz/Blue Train.flac"],
      preferred_path: "/Volumes/Media/Jazz/Blue Train.flac",
      reclaimable_bytes: 23800000,
      details: { source_group_id: "exact-001" },
    },
    {
      item_id: "likely_duplicate_group-21f984264b20",
      item_type: "likely_duplicate_group",
      priority_band: "medium",
      priority_score: 82,
      summary: "Review likely duplicate set: 'Night Drive'",
      reason_summary: "Filename similarity and close duration need a manual decision.",
      review_status: "seen",
      affected_paths: [
        "/Volumes/Media/Electronic/Night Drive.flac",
        "/Downloads/Night Drive (Final).mp3",
      ],
      sample_paths: ["/Volumes/Media/Electronic/Night Drive.flac"],
      preferred_path: "/Volumes/Media/Electronic/Night Drive.flac",
      confidence: 0.82,
      details: { source_group_id: "likely-001" },
    },
    {
  ...
  items: [
    {
      ...
      latest_tracks: [
        {
          path: "/music/jazz/Blue Train (2024 Remaster).flac",
          score: 5.4,
          reasons: ["genre:hard bop"],
          title: "Blue Train",
    ...
    },
    {
      ...
      latest_tracks: [
        {
          path: "/music/ambient/Stillness.wav",
          score: 4.8,
          reasons: ["mood:focus", "instrumental_hint"],
          title: "Stillness",
          artist: "Local Artist",
      ...
      operations: [
        {
          ...
          reversible: true,
          undo_status: "ok",
          undone_at: "2026-03-06T13:15:45+00:00",
